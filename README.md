...
I completed this project in partial completion of the Udacity Fullstack Nanodegree. 
...
3. Run the development server:
  ```
  $ export FLASK_APP=app #pmnote: had to change from myapp to app because the server file name is app.py
  $ export FLASK_ENV=development # enables debug mode
  $ python3 app.py #pmnote: change to python app.py
  ```
